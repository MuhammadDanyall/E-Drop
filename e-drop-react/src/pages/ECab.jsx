...
const ECab = ({ onAuthClick }) => {
    ...
    return (
        <main id="ecab-page">
            ...
            {/* 6. Download App */}
            <section className="download-app-ecab animate-on-scroll">
                <div className="container download-flex">
                    <div className="download-content animate-on-scroll fade-in-left">
                        <h2>Get the E-Drop App Today!</h2>
                        <p>Experience fast, reliable, and safe rides by downloading our app from your preferred store.</p>
                    </div>
                    <div className="download-image">
                        <img src="/pictures/phone_app.png" alt="Phone" />
                    </div>
                </div>
            </section>
